...
def cnn_model_fn(features, labels, mode):
  ...
  # print_op1 = tf.print(y.get_shape())
  ...
  if mode == tf.estimator.ModeKeys.TRAIN:
    ...
    if FLAGS.dpsgd:
      ...
      # ledger = None  # ignore ledger as final epsilon is already known, in order to save some resources
...
def main():
  ...
  # cnn_model_fn, layers = make_model_fn()
